...
public class NavigationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(R.id.nav_run, R.id.nav_rank, R.id.nav_task, R.id.nav_history, R.id.nav_profile, R.id.nav_settings, R.id.nav_logout)
